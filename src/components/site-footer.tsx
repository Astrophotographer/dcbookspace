...
//   - VERSION: SemVer 형식 'vMAJOR.MINOR.PATCH'
//   - RELEASE_DATE: 배포일을 MM.DD 로
//   - production 이 아니면 화면에는 자동으로 " - DEV(test)" 를 붙인다.
//
...
//   - develop/staging/preview/local: 버전 옆에 " - DEV(test)" 자동 표시
//   - main production: " - DEV(test)" 제거
...
export function SiteFooter() {
  ...
  return (
    ...
    <footer className="mt-auto border-t border-stone-200 bg-white py-3 text-center text-xs print:hidden">
      <span className="text-stone-500">{versionLabel}</span>
