...
import { deleteSeries } from "@/app/apply/actions";
...
export function OwnerActions({
  ...
  function handleDelete() {
    ...
    startTransition(async () => {
      const res = await deleteSeries(seriesId, me.name, me.phone);
      if (res.error) {
        setError(res.error);
        return;
      }
    ...
    >
      <div className="w-full max-w-md rounded-2xl bg-white shadow-xl">
        ...
        <div className="px-6 py-5 text-stone-700">
          <p className="mb-3">
            시리즈를 삭제하면 <strong>총 {totalRows}개의 회차 예약</strong>이
            모두 함께 사라집니다. 결재 진행 내역도 같이 삭제되며 되돌릴 수
            없어요.
          </p>
